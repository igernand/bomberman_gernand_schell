...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    if(bigtable_on == 1):
        self.coin2table = build_big_qtable2(self.qtable[1:16,2:16])
        self.coin3table = build_big_qtable3(self.qtable[1:16,2:16])
    
        with open("my-saved-coin2table.pt", "wb") as file:
            pickle.dump(self.coin2table, file)
        with open("my-saved-coin3table.pt", "wb") as file:
            pickle.dump(self.coin3table, file)
