...
def act(self, game_state: dict) -> str:
    ...
    if self.train and random.random() < random_prob:
        ...
        #if board[x_self,y_self+1]==1 or board[x_self+1,y_self]==1 or board[x_self,y_self-1]==1 or board[x_self-1,y_self]==1:
            #print("bomb found through random action in training")
            #return 'BOMB'
            #return np.random.choice(ACTIONS, p=[.05, .05, .05, .05, .8, 0]) #evtl damit trainieren
        #else:
