...
def game_events_occurred(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    ...
    '''for event in events:
        ...
        if event == e.BOMB_DROPPED:
            ...
            old_board =  old_game_state["field"]
    ...
    if new_game_state["step"] != 1:
        ...
        #board = new_game_state["field"]
        #if board[x,y+1]==1 or board[x+1,y]==1 or board[x,y-1]==1 or board[x-1,y]==1:
        #    temp_diff = reward_from_events(self, events) + GAMMA * np.max(self.qtable[y][x][0:5]) - old_q_value
        #else:
