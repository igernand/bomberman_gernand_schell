...
def game_events_occurred(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    ...
    elif (x,y) == (7,4) or (x,y) == (7,10) or (x,y) == (4,7) or (x,y) == (10,7) or (x,y) == (5,6) or (x,y) == (5,8) or (x,y) == (9,6) or (x,y) == (9,8) or (x,y) == (6,5) or (x,y) == (8,5) or (x,y) == (6,9) or (x,y) == (8,9):
        events.append(BOMB_3)
    elif (x,y) == (7,3) or (x,y) == (7,11) or (x,y) == (3,7) or (x,y) == (11,7) or (x,y) == (5,9) or (x,y) == (5,5) or (x,y) == (9,9) or (x,y) == (9,5):
